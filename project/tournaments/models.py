...
class EstadosTorneo(models.Model):
    ...
    torneos_id_torneo = models.OneToOneField(
        'Torneos',
        models.DO_NOTHING,
        db_column='torneos_id_torneo',
        related_name='estado_torneo'   # <-- acceso desde Torneos: torneo.estado_torneo
    )
...
class Torneos(models.Model):
    ...
    #BORRAR esta línea (provocaba ORA-00904):
    # estados_torneo_id_estado_torneo = models.OneToOneField(
