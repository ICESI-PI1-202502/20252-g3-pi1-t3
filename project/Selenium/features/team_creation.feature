Feature: Team creation in tournaments
  ...
  Scenario: Creación exitosa de un equipo
    ...
    And I create a team named "Equipo - Julian Alvarado" with responsible "1105365296", discipline "Tenis de Mesa", min 1 and max 16
    Then I should see the team "Equipo - Julian Alvarado" in the tournament details