Feature: CADI - Creación de actividad grupal por administrador
  ...
  Scenario: Crear actividad "Voleibol Mixto (Formativo)" en Deportes de Conjunto
    ...
    And I create a CADI activity named "Voleibol Mixto (Formativo)" of type "Deportes de Conjunto" with capacity 10, requires "No" and description:
      """
      Día: Martes
      Horario: 18:00–20:00
      Espacio: Coliseo 1
