...
# ==========================================================
# TESTS DE VISTAS CON BASE DE DATOS (TestCase)
# ==========================================================

@override_settings(STATICFILES_STORAGE="django.contrib.staticfiles.storage.StaticFilesStorage")
class TestShowGroupActivities(TestCase):
    """Pruebas para showGroupActivities"""
    
    def setUp(self):
        from management_CADI.tests.models import Grupos, GruposActividad, Roles
        from django.contrib.auth.models import User
...
@override_settings(STATICFILES_STORAGE="django.contrib.staticfiles.storage.StaticFilesStorage")
class TestShowActivities(TestCase):
    """Pruebas para showActivities (listar_actividades)"""
    
    def setUp(self):
        from management_CADI.tests.models import (
            Grupos, GruposActividad, TiposActividad, Actividades,
            ActividadesGrupos, HorariosBloque, HorariosActividad,
            Roles, Participantes
        )
        from django.contrib.auth.models import User
    ...
    def test_rating_bucket_and_user_has_calificado(self):
        ...
        from management_CADI.tests.models import CalificacionesActividad
        from django.contrib.auth.models import User
